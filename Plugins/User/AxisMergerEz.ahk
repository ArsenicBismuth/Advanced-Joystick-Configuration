...
*/
class AxisMergerEz extends _UCR.Classes.Plugin {
	Type := "Remapper (Axis Merger) + Multiplier"
	Description := "Merges multiplied two input axes into one output virtual axis"
	vAxis := 0
	vDevice := 0
	...
	Init(){
		...
		Gui, Add, Text, % "x270 y20 w70 Center", Mode
		Gui, Add, Text, % "x+5 y20 w50 Center", Deadzone
		...
		Gui, Add, Text, % "x270 yp+30 w50 Left", Input1 x
		this.AddControl("Edit", "Multi1", this.MyEditChanged.Bind(this), "x+0 yp w30", "1")
		Gui, Add, Text, % "x270 yp+30 w50 Left", Input2 x
		this.AddControl("Edit", "Multi2", this.MyEditChanged.Bind(this), "x+0 yp w30", "1")
	}
